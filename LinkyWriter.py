...
styles = ['algemeen', 'informatief', 'professioneel', 'informeel', 'formeel', 'basic', 'oppervlakkig', 'diepgaand',
          'samenhangend', 'relaxed', 'educatief', 'eenvoudig', 'vrolijk', 'luchtig']
...
while True:
    ...
    if mode == "t":
        ...
        msg = f"Schrijf een tekst van minstens {int(n_words)} woorden. Maak de tekst {style[0]} en {style[1]}, " \
              f"maak het niet al te commercieel of adverterend. De tekst moet de volgende zoekterm(en) bevatten: " \
              f"{keywords} de zoektermen moeten VERBATIM overgenomen worden. Verdeel de tekst in {int(n_pars)} " \
              f"alinea's."
